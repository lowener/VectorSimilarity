...
const char *VecSimCommonStrings::CUVSIVFFLAT_STRING = "CUVS_IVF_FLAT";
const char *VecSimCommonStrings::CUVSIVFPQ_STRING = "CUVS_IVF_PQ";
...
const char *VecSimAlgo_ToString(VecSimAlgo vecsimAlgo) {
    ...
    case VecSimAlgo_CUVS_IVFFLAT:
        return VecSimCommonStrings::CUVSIVFFLAT_STRING;
    case VecSimAlgo_CUVS_IVFPQ:
        return VecSimCommonStrings::CUVSIVFPQ_STRING;
